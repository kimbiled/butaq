    ...
    return(
        <>
          <div className="m-10 mx-auto p-16 sm:p-24 lg:p-48 mt-[-80px]">
            ...
            <div className="w-full md:w-3/5 h-full flex items-center bg-[#DEFFEE] rounded-lg">
                <div className="p-12 md:pr-24 md:pl-16 md:py-12">
                    <p className="text-gray-600"><span className="text-gray-900">Какой то текст</span> Партию электронных сигарет с психотропными веществами пытались завезти в Казахстан из США, сообщает «24KZ» со ссылкой на пресс-службу Агентства по финансовому мониторингу. Почтовые посылки с вейпами выявили в зоне таможенного поста «Жетісу». В них находились больше 80 сигарет. В результате проведённых следственных мероприятий, представители АФМ изъяли ещё 103 вейпа и 42 клиромайзера.</p>
                    <a className="flex items-baseline mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900" href="">
                        <span>Узнать подробнее</span>
                        <span className="text-xs ml-1">&#8594;</span>
                    </a>
                </div>
                <svg className="hidden md:block absolute inset-y-0 h-full w-24 fill-current text-[#DEFFEE] -ml-12" viewBox="0 0 100 100" preserveAspectRatio="none">
