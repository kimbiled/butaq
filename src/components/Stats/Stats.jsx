...
export default function Stats() {
    return(
        <>
          <div className="m-10 mx-auto p-16 sm:p-24 lg:p-48 mt-[-80px]">
            <div className="relative rounded-lg block md:flex items-center shadow-xl">
            <div className="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg">
                <img className="w-[460px] h-[387px] object-cover object-center rounded-tl-lg rounded-bl-lg" src="https://www.zakon.kz/pbi/WEBP/2024-03-26/file-7cb1ca9b-b9f4-4539-bd12-bbd36df6e196/800x450.webp" alt="" />
                <div className="absolute inset-0 w-full h-full bg-[#DEFFEE] opacity-75"></div>
            ...
            <div className="w-full md:w-3/5 h-full flex items-center bg-[#4cc9f0] rounded-br-lg rounded-tl-lg rounded-tr-lg">
                <div className="p-8 md:pr-16 md:pl-14 md:py-8">
                    <p className="text-white">Президент Казахстана Касым-Жомарт Токаев выразил озабоченность ростом наркоторговли, называя ее "настоящей эпидемией". Он подчеркнул необходимость борьбы с наркотиками и предложил ужесточить наказание за их производство. Заместитель начальника департамента по противодействию наркопреступности МВД РК Бакытжан Амирханов подтвердил увеличение объема синтетических наркотиков в стране, обратив внимание на локальное производство. Проблема также связана с использованием легальных прекурсоров для изготовления наркотиков. План борьбы включает меры по профилактике наркозависимости и блокировке наркопродаж в интернете. Правоохранительные органы сообщили о блокировке тысяч сайтов, однако работа по противодействию наркоторговле продолжается. </p>
                    <a className="flex items-baseline mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900" href="">
                    <span>Узнать подробнее</span>
                    <span className="text-xs ml-1">&#8594;</span>                   
                    </a>
                </div>
                <svg className="hidden md:block absolute inset-y-0 h-full w-28 fill-current text-[#4cc9f0] -ml-[56px]" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            {/* <div className="flex items-center pt-5 justify-between">
                <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full" src="" alt=""/></button>
                <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full" src="" alt="" /></button>
                <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full" src="" alt="" /></button>
                <button className="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img className="w-full" src="" alt="" /></button>
                <button className="px-2 opacity-100 hover:opacity-100 focus:opacity-100"><img className="w-full" src="" alt="" /></button>
            </div> */}
        </div>
        </>
    )
